        ...
        <div id="sidebar-menu">
          ...
          <ul className="metismenu" id="side-menu">
            ...
            <Link to='/confirmation'>
              <i className="icon-paper-sheet" /><span> Confirmation <span className="float-right menu-arrow"></span> </span>
              </Link>
            </li>
            <li>
            <Link to='/buyer'>
            ...
            <Link to='/orderdelivery'>
              <i className="icon-paper-sheet" /><span> Order Delivery <span className="float-right menu-arrow"></span> </span>
              </Link>
            </li>
            <li>
            ...
            {/* Buyer Tracking */}
            <li>
            <Link to='/buyertracking'>
              <i className="icon-paper-sheet" /><span> Buyer Tracking <span className="float-right menu-arrow"></span> </span>
              </Link>
            </li>
            ...
            {/* Buyer Tracking */}
            <li>
            <Link to='/sellertracking'>
              <i className="icon-paper-sheet" /><span> Seller Tracking <span className="float-right menu-arrow"></span> </span>
              </Link>
            </li>
