...
class PaymentMethod extends React.Component {
  ...
  uploadImage = async () => {
    try {
      ...
      console.log(data)
      const response = await axios.post("https://api.cloudinary.com/v1_1/dmvvzljrj/image/upload", data)
      console.log(response.data)




      // let uploaded = await lecturer.imageuploaded(data)
    } catch (error) {
      console.log(error)
    }
  }

  imageuploaded = async (data) => {
    try {
      const response = await axios.post('http://localhost:3000/order/imageupload',
        data
                ...
                <div className="container">
                  ...
                  <div className="row">
                    ...
                    <div className="col">
                      ...
                      <button type="button" class="btn btn-primary" style={({ marginTop: "20px" })} onClick={this.uploadImage}>Transferred, Next</button>
